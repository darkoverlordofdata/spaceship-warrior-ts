module example.systems {
  ...
  export class SpriteRenderSystem extends EntitySystem {
    ...
    private spriteBatch:cc.SpriteBatchNode;
    ...
    public initialize() {
      ...
      this.spriteBatch = EntitySystem.blackBoard.getEntry<cc.Node>('spriteBatch');
    ...
    public processEach(e:Entity) {
      if (this.pm.has(e)) {
        ...
        sprite.sprite_.setPosition(cc.p(position.x, Constants.FRAME_HEIGHT - position.y));
      }
    }
